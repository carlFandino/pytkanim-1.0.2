class NormalAnimHeight:
	"""This animates the HEIGHT of the widget given. speed param can be ex.1000 = 1 second or 100 = 1ms or 10 for smoother animation.
    
    Run anim when button is clicked.
	>>> import tkinter as tk
    >>> 
    >>> root = tk.Tk()
    >>> Label = NormalAnimsHeight(tk.Label(bg="black"),speed=20)
